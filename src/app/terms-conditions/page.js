        ...
        <>
            <div className="w-full min-h-screen flex justify-center bg-[#f3f9fb] pt-11 pb-36">
                <div className="bg-white w-full max-w-4xl h-auto p-8 rounded-lg shadow-lg border mt-10 mx-4 sm:mx-10 mb-10 pt-20 border-gray-300">
                    <h1 className="font-bold text-3xl mb-6 text-[#000000]">Terms & Conditions</h1>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">1. Scope of Service:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">2. Disclaimer of Accuracy:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">3. Limitation of Liability:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">4. User Responsibility:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">5. Refunds Policy:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">6. Intellectual Property:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">7. Indemnification:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">8. Changes to Terms and Conditions:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">9. Governing Law and Jurisdiction:</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-8 mb-6 text-black">10. Contact Information:</h2>
